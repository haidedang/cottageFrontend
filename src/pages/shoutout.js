        ...
        <div className={ShoutoutStyles.wrapper} >
            <div className={ShoutoutStyles.image}>
                <div className={ShoutoutStyles.container}>
                    ...
                    <div >
                        <p className={ShoutoutStyles.landingText}>Welcome to the Cottage Dream! Every week we will select some of your submitted pictures and share them on our Instagram Channel. Let’s build a cottagecore community together!</p>
                    </div>
                </div>
            </div>
            ...
            <Container className={ShoutoutStyles.requirements}>
                ...
                <div className={[ShoutoutStyles.requirementWrapper, "mb-5", "mt-5"].join(' ')}>

                    <Row xs={1} className={[ShoutoutStyles.requirementBody].join(' ')} >
                        <Col className="col-md-4 text-center" >
                            <div className={[ShoutoutStyles.frameIcon, ShoutoutStyles.icon, "mt-3", "mb-3"].join(' ')} >
                            </div>
                            <p> 9:16 or 4:5 format</p>
                        </Col>

                        <Col className="col-md-4 text-center">
                            <div className={[ShoutoutStyles.photoIcon, ShoutoutStyles.icon, "mt-3", "mb-3"].join(' ')} >
                            </div>
                            <p> should be your own picture</p>
                        </Col>

                        <Col className="col-md-4 text-center" >
                            <div className={[ShoutoutStyles.heartIcon, ShoutoutStyles.icon, "mt-3", "mb-3"].join(' ')} >
                            </div>
            ...
            <div id="about" className={ShoutoutStyles.about}>
                ...
                <Row>
                    ...
                    <Col className={[ShoutoutStyles.aboutText, "col-md-12 my-auto"].join(' ')}>  
