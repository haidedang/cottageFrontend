...
const IndexPage = () => {
  ...
  return (
    <Layout seo={data.strapiHomepage.seo} header={<h1 className="pt-10 text-center text-3xl md:text-6xl" style={{ color: "#456b45" }}>
      {data.strapiHomepage.hero.title}
    </h1>} footer = {<Footer />}>
  
        <div className=" md:mt-24 flex justify-center flex-wrap" style={{ maxWidth: "1800px", margin: "auto" }}>
          <article className=" w-11/12 md:w-8/12 md:pb-24">
          ...
          <aside className="w-11/12 pl-4 pr-4 md:ml-0 md:mr-0 md:w-4/12 lg:w-4/12 2xl:w-1/5 ">
            <Sidebar />
          </aside>
